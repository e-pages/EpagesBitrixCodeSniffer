 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class EpagesPEAR_Sniffs_Functions_FunctionDeclarationSniff implements PHP_CodeSniffer_Sniff
{
     ...
     *
     * Just uses the EpagesGeneric BSD-Allman brace sniff.
     *
     * @param PHP_CodeSniffer_File $phpcsFile The file being scanned.
     * @param int                  $stackPtr  The position of the current token
     *                                        in the stack passed in $tokens.
    ...
    {
        if ($tokens[$stackPtr]['code'] === T_CLOSURE) {
            if (class_exists('EpagesGeneric_Sniffs_Functions_OpeningFunctionBraceKernighanRitchieSniff', true) === false) {
                throw new PHP_CodeSniffer_Exception('Class EpagesGeneric_Sniffs_Functions_OpeningFunctionBraceKernighanRitchieSniff not found');
            }

            $sniff = new EpagesGeneric_Sniffs_Functions_OpeningFunctionBraceKernighanRitchieSniff();
        } else {
            if (class_exists('EpagesGeneric_Sniffs_Functions_OpeningFunctionBraceBsdAllmanSniff', true) === false) {
                throw new PHP_CodeSniffer_Exception('Class EpagesGeneric_Sniffs_Functions_OpeningFunctionBraceBsdAllmanSniff not found');
            }

            $sniff = new EpagesGeneric_Sniffs_Functions_OpeningFunctionBraceBsdAllmanSniff();
        }
