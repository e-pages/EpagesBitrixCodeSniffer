...
class EpagesPEAR_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        $tokens     = $phpcsFile->getTokens();
        $docBlock   = (get_class($this) === 'EpagesPEAR_Sniffs_Commenting_FileCommentSniff') ? 'file' : 'class';
        $commentEnd = $tokens[$commentStart]['comment_closer'];
